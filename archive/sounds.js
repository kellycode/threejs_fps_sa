...
sounds.normal = soundLoader.loadAudio(manifest);
...
sounds.positional.bow = soundLoader.loadPositionalAudio([
    { id: "bow", url: "assets/sounds/bow.ogg", volume: 0.5, setRefDistance: 8 },
]);
