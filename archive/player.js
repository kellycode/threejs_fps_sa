function createPlayer(hud) {
    ...
    let t_player = new PlayerBase(hud);
    ...
    var weapons = Global_Store.weapons;//initWeapons(hud);
    ...
    function onDocumentKeyDown(event) {
        ...
        switch (keycode) {
            case 82: //R
                ...
                toggle2 = !toggle2;
                if (this.inHands instanceof WeaponClass) {
    ...
    function handleMouseDown(event) {
        ...
        if (!fpsMoverInstance.getControls().enabled) {
            return;
        }
